...
function LeftMenu() {
  return (
    <aside id="logo-sidebar" class={css.aside} aria-label="Sidebar">
      <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
          <li>
            <A href="/dashboard" class={css.a} activeClass="underline">
              <BiSolidDashboard />
              <span class="ml-3">Dashboard</span>
            </A>
          </li>
          <li>
            <A href="/team" class={css.a} activeClass="underline">
